...
| :--- | :--- | :--- | :--- | :--- |
| **Hero Name / H1** | `text-2xl sm:text-3xl md:text-4xl` | `font-bold` | `text-foreground` | `tracking-tight leading-tight` |
| **Position / Subtitle (H2/H3)** | `text-base sm:text-lg` | `font-semibold` / `font-medium` | `text-muted-foreground` or `text-primary` | `tracking-normal leading-snug` |
